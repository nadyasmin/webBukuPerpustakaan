...
values
	...
	('ROM002', 'Dikta & Hukum', 'Romantis', '2021', 'Dhia'an Farah', 'ASOKA AKSARA X LOVEABLE', 'N001', 'Tersedia')
	('ROM003', 'Dilan 1990', 'Romantis', '2015', 'Pidi Baiq', 'DAR! Mizan', 'N001', 'Dipinjam')
	('AKS001', 'Tiga Sandera Terakhir', '2015', 'Brahmanto Anindito', 'Noura Publishing', 'N002', 'Tersedia')
	('AKS002', 'Seteru 1 Guru', '2015', 'Haris Priyatna', 'Bandung Qanita', 'N002', 'Dipinjam')
	;
